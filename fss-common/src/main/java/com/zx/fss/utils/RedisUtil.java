...
public class RedisUtil {
    ...
    public void delPattern(String keyPattern) {
        ...
        if (keys != null && !keys.isEmpty()) {
            ...
            redisTemplate.executePipelined((RedisCallback<String>) connection -> {
                ...
                keys.forEach(key -> connection.del(redisSerializer.serialize(key)));
                return null;
            }, redisSerializer);
        }
    }
    ...
    public Map<String, Map<Object, Object>> hmgetPattern(String keyPattern) {
        ...
        if (keys != null && !keys.isEmpty()) {
            redisTemplate.executePipelined((RedisCallback<Long>) connection -> {
                connection.openPipeline();
                for (String key : keys) {
                    Map<Object, Object> objectMap = hmget(key);
    ...
    public void set(String prefix, int i, long l, TimeUnit milliseconds) {
        redisTemplate.opsForValue().set(prefix, i, l, milliseconds);
    }

    public int keys(String pattern) {

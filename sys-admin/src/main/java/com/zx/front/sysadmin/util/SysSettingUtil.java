package com.zx.front.sysadmin.util;


import com.zx.front.sysadmin.entity.SysSettingVo;
...
public class SysSettingUtil {
    ...
    public static SysSettingVo getSysSetting(){
        SysSettingVo sysSetting = sysSettingMap.get("sysSetting");
        if(sysSetting == null){
            sysSetting = SysSettingVo.builder()
                    .sysName("文件管理系统")
                    .sysColor("rgb(108,159,202)").build();
        }
        return sysSetting;
    }
